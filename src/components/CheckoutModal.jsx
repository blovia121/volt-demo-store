      ...
      {isCheckoutOpen && (
        <>
          ...
          <motion.section
            ...
            className="fixed inset-4 md:inset-20 bg-white/90 rounded-3xl border border-white/20 shadow-2xl z-50 overflow-y-auto"
          >
            <section className="p-8 max-w-2xl mx-auto">
              ...
              {/* Order Summary */}
              <section className="bg-white/50 rounded-2xl p-6 border border-white/20 mb-6">
                ...
                <form className="space-y-4">
                  <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      className="bg-white/80 border border-white/20 rounded-2xl px-4 py-3 font-light focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                    />
                    <input
                      type="text"
                  ...
                  <input
                    ...
                    className="w-full bg-white/80 border border-white/20 rounded-2xl px-4 py-3 font-light focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                  />
                  <input
                    type="text"
                  ...
                  <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <input
                      ...
                      className="bg-white/80 border border-white/20 rounded-2xl px-4 py-3 font-light focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                    />
                    <select className="bg-white/80 border border-white/20 rounded-2xl px-4 py-3 font-light focus:outline-none focus:ring-2 focus:ring-orange-500/50">
              ...
              <section className="bg-white/50 rounded-2xl p-6 border border-white/20 mb-6">
                ...
                <section className="space-y-3">
                  <label className="flex items-center gap-3 p-4 bg-white/80 rounded-2xl border border-white/20 cursor-pointer">
